...
class Content extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('id, title_az, title_en, title_ru, content_az, content_en, content_ru, catID, albumID, isBlog, imgUrl, catName', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function relations()
    {
        ...
        return array(
            ...
            'contentVideos' => array(self::HAS_MANY, 'ContentVideo', 'contentID'),
        );
    }
